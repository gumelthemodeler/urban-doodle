...
-- [[ THE FIX: Bulletproof Universal Gradient Helper ]]
...
function BountiesTab.Init(parentFrame, tooltipMgr)
	...
	-- [[ PC HORIZONTAL COLUMNS CONTAINER ]]
	...
	ccLayout.Padding = UDim.new(0.04, 0)
	...
	DailiesList = Instance.new("Frame", LeftCol)
	DailiesList.Size = UDim2.new(1, 0, 0, 0); DailiesList.AutomaticSize = Enum.AutomaticSize.Y; DailiesList.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
	...
	WeekliesList = Instance.new("Frame", RightCol)
	WeekliesList.Size = UDim2.new(1, 0, 0, 0); WeekliesList.AutomaticSize = Enum.AutomaticSize.Y; WeekliesList.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
	...
	local function CreateBountyRow(parent, idKey, isWeekly, order)
		...
		row.Name = idKey; row.Size = UDim2.new(0.95, 0, 0, 95); row.BackgroundColor3 = Color3.fromRGB(22, 22, 28)
		row.LayoutOrder = order
		Instance.new("UICorner", row).CornerRadius = UDim.new(0, 6)
		local stroke = Instance.new("UIStroke", row)
		stroke.Color = Color3.fromRGB(60, 60, 70); stroke.Thickness = 1; stroke.Transparency = 0.55; stroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
		...
		infoLbl.Name = "Info"; infoLbl.Size = UDim2.new(1, -25, 0, 40); infoLbl.Position = UDim2.new(0, 15, 0, 8); infoLbl.BackgroundTransparency = 1; infoLbl.Font = Enum.Font.GothamBold; infoLbl.TextColor3 = Color3.fromRGB(230, 230, 230); infoLbl.TextScaled = true; infoLbl.TextXAlignment = Enum.TextXAlignment.Left; infoLbl.TextYAlignment = Enum.TextYAlignment.Top; infoLbl.TextWrapped = true; infoLbl.RichText = true
		...
		barCont.Size = UDim2.new(0.65, 0, 0, 14); barCont.Position = UDim2.new(0, 15, 1, -24); barCont.BackgroundColor3 = Color3.fromRGB(15, 15, 20); Instance.new("UICorner", barCont).CornerRadius = UDim.new(0, 6)
		...
		btn.Name = "ActionBtn"; btn.Size = UDim2.new(0.28, 0, 0, 32); btn.Position = UDim2.new(1, -10, 1, -12); btn.AnchorPoint = Vector2.new(1, 1); btn.Font = Enum.Font.GothamBlack; btn.TextScaled = true; btn.Text = "IN PROGRESS"
