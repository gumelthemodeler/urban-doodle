...
function CombatTab.Init(parentFrame, tooltipMgr)
	...
	MainFrame.Name = "CombatFrame"; MainFrame.Size = UDim2.new(0, 750, 0, 520); MainFrame.Position = UDim2.new(0.5, 0, 0.5, 0); MainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
	...
	PSModal.Size = UDim2.new(0, 600, 0, 480)
	...
	psTitle.Size = UDim2.new(0.5, 0, 1, 0); psTitle.Position = UDim2.new(0, 15, 0, 0); psTitle.BackgroundTransparency = 1; psTitle.Font = Enum.Font.GothamBlack; psTitle.TextColor3 = Color3.fromRGB(85, 255, 255); psTitle.TextSize = 16; psTitle.TextXAlignment = Enum.TextXAlignment.Left; psTitle.Text = "THE PATHS"
	psTitle.ZIndex = 2

	psDust = Instance.new("TextLabel", psHeader)
	psDust.Size = UDim2.new(0.5, 0, 1, 0); psDust.Position = UDim2.new(0.5, -15, 0, 0); psDust.BackgroundTransparency = 1; psDust.Font = Enum.Font.GothamBlack; psDust.TextColor3 = Color3.fromRGB(255, 255, 255); psDust.TextSize = 16; psDust.TextXAlignment = Enum.TextXAlignment.Right; psDust.Text = "PATH DUST: 0"
	psDust.ZIndex = 2

	local psLeaveBtn = Instance.new("TextButton", PSModal)
	psLeaveBtn.Size = UDim2.new(1, -30, 0, 40); psLeaveBtn.Position = UDim2.new(0, 15, 1, -55)
	...
	psScroll.Size = UDim2.new(1, -10, 1, -110); psScroll.Position = UDim2.new(0, 5, 0, 45); psScroll.BackgroundTransparency = 1; psScroll.ScrollBarThickness = 4; psScroll.ZIndex = 2
	...
	PopulatePathsShop = function(data)
		...
		local ngl = Instance.new("UIGridLayout", nGrid); ngl.CellSize = UDim2.new(0.48, 0, 0, 90); ngl.CellPadding = UDim2.new(0.03, 0, 0, 10); ngl.SortOrder = Enum.SortOrder.LayoutOrder
		...
		for _, node in ipairs(data.Nodes) do
			...
			local cTitle = Instance.new("TextLabel", card); cTitle.Size = UDim2.new(1, -20, 0, 20); cTitle.Position = UDim2.new(0, 10, 0, 5); cTitle.BackgroundTransparency = 1; cTitle.Font = Enum.Font.GothamBlack; cTitle.TextColor3 = Color3.fromRGB(255, 215, 100); cTitle.TextSize = 14; cTitle.TextXAlignment = Enum.TextXAlignment.Left; cTitle.Text = node.Name
			local cDesc = Instance.new("TextLabel", card); cDesc.Size = UDim2.new(1, -20, 0, 30); cDesc.Position = UDim2.new(0, 10, 0, 25); cDesc.BackgroundTransparency = 1; cDesc.Font = Enum.Font.GothamMedium; cDesc.TextColor3 = Color3.fromRGB(200, 200, 200); cDesc.TextSize = 11; cDesc.TextWrapped = true; cDesc.TextXAlignment = Enum.TextXAlignment.Left; cDesc.TextYAlignment = Enum.TextYAlignment.Top; cDesc.Text = node.Desc

			local btn = Instance.new("TextButton", card); btn.Size = UDim2.new(0.45, 0, 0, 25); btn.Position = UDim2.new(1, -10, 1, -30); btn.AnchorPoint = Vector2.new(1, 0); btn.Font = Enum.Font.GothamBold; btn.TextColor3 = Color3.fromRGB(255, 255, 255); btn.TextSize = 11; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 4)
		...
		local rgl = Instance.new("UIGridLayout", rGrid); rgl.CellSize = UDim2.new(0.48, 0, 0, 90); rgl.CellPadding = UDim2.new(0.03, 0, 0, 10); rgl.SortOrder = Enum.SortOrder.LayoutOrder
		...
		for _, item in ipairs(data.Items) do
			...
			local cTitle = Instance.new("TextLabel", card); cTitle.Size = UDim2.new(1, -20, 0, 20); cTitle.Position = UDim2.new(0, 10, 0, 5); cTitle.BackgroundTransparency = 1; cTitle.Font = Enum.Font.GothamBlack; cTitle.TextColor3 = Color3.fromRGB(255, 150, 150); cTitle.TextSize = 14; cTitle.TextXAlignment = Enum.TextXAlignment.Left; cTitle.Text = item.Name
			local cDesc = Instance.new("TextLabel", card); cDesc.Size = UDim2.new(1, -20, 0, 30); cDesc.Position = UDim2.new(0, 10, 0, 25); cDesc.BackgroundTransparency = 1; cDesc.Font = Enum.Font.GothamMedium; cDesc.TextColor3 = Color3.fromRGB(200, 200, 200); cDesc.TextSize = 11; cDesc.TextWrapped = true; cDesc.TextXAlignment = Enum.TextXAlignment.Left; cDesc.TextYAlignment = Enum.TextYAlignment.Top; cDesc.Text = item.Desc

			local btn = Instance.new("TextButton", card); btn.Size = UDim2.new(0.5, 0, 0, 25); btn.Position = UDim2.new(0.5, -10, 1, -30); btn.AnchorPoint = Vector2.new(0, 0); btn.Font = Enum.Font.GothamBold; btn.TextColor3 = Color3.fromRGB(255, 255, 255); btn.TextSize = 11; Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 4)
	...
	CombatantsFrame.Size = UDim2.new(0.96, 0, 0, 100); CombatantsFrame.BackgroundTransparency = 1
	...
	pAvatarBox.Size = UDim2.new(0, 80, 0, 80); pAvatarBox.Position = UDim2.new(0, 0, 0.5, 0); pAvatarBox.AnchorPoint = Vector2.new(0, 0.5); pAvatarBox.BackgroundColor3 = Color3.fromRGB(10, 10, 15)
	...
	pStatsArea.Size = UDim2.new(1, -90, 1, 0); pStatsArea.Position = UDim2.new(0, 90, 0, 0); pStatsArea.BackgroundTransparency = 1
	local pLayout = Instance.new("UIListLayout", pStatsArea); pLayout.SortOrder = Enum.SortOrder.LayoutOrder; pLayout.Padding = UDim.new(0, 4); pLayout.VerticalAlignment = Enum.VerticalAlignment.Center
	...
	PlayerNrgBar, PlayerNrgText, PlayerNrgContainer = CreateBar(pStatsArea, Color3.fromRGB(255, 150, 50), Color3.fromRGB(180, 80, 20), UDim2.new(1, 0, 0, 12), "HEAT: 0", false); PlayerNrgContainer.Visible = false

	PlayerStatusBox = Instance.new("Frame", pStatsArea)
	PlayerStatusBox.Size = UDim2.new(1, 0, 0, 20); PlayerStatusBox.BackgroundTransparency = 1
	local pStatusLayout = Instance.new("UIListLayout", PlayerStatusBox); pStatusLayout.FillDirection = Enum.FillDirection.Horizontal; pStatusLayout.Padding = UDim.new(0, 4)
	...
	eAvatarBox.Size = UDim2.new(0, 80, 0, 80); eAvatarBox.Position = UDim2.new(1, 0, 0.5, 0); eAvatarBox.AnchorPoint = Vector2.new(1, 0.5); eAvatarBox.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	...
	eStatsArea.Size = UDim2.new(1, -90, 1, 0); eStatsArea.Position = UDim2.new(0, 0, 0, 0); eStatsArea.BackgroundTransparency = 1
	...
	EnemyNameText.Size = UDim2.new(1, 0, 0, 15); EnemyNameText.BackgroundTransparency = 1; EnemyNameText.Font = Enum.Font.GothamBlack; EnemyNameText.TextColor3 = Color3.fromRGB(255, 120, 120); EnemyNameText.TextSize = 14; EnemyNameText.TextScaled = true; EnemyNameText.TextXAlignment = Enum.TextXAlignment.Right

	local eHpCont
	EnemyHPBar, EnemyHPText, eHpCont = CreateBar(eStatsArea, Color3.fromRGB(220, 60, 60), Color3.fromRGB(140, 30, 30), UDim2.new(1, 0, 0, 14), "HP: 100", true)
	...
	EnemyStatusBox.Size = UDim2.new(1, 0, 0, 20); EnemyStatusBox.BackgroundTransparency = 1
	local eStatusLayout = Instance.new("UIListLayout", EnemyStatusBox); eStatusLayout.FillDirection = Enum.FillDirection.Horizontal; eStatusLayout.HorizontalAlignment = Enum.HorizontalAlignment.Right; eStatusLayout.Padding = UDim.new(0, 4)
	...
	LogText.Size = UDim2.new(1, -20, 1, -10); LogText.Position = UDim2.new(0, 10, 0, 5); LogText.BackgroundTransparency = 1; LogText.Font = Enum.Font.GothamMedium; LogText.TextColor3 = Color3.fromRGB(230, 230, 230); LogText.TextSize = 13; LogText.TextXAlignment = Enum.TextXAlignment.Left; LogText.TextYAlignment = Enum.TextYAlignment.Bottom; LogText.TextWrapped = true; LogText.RichText = true; LogText.Text = ""
	...
	gridLayout.CellSize = UDim2.new(0, 170, 0, 45); gridLayout.CellPadding = UDim2.new(0, 8, 0, 12); gridLayout.SortOrder = Enum.SortOrder.LayoutOrder; gridLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
	...
	LeaveBtn = Instance.new("TextButton", MainFrame); LeaveBtn.Size = UDim2.new(0.6, 0, 0, 45); LeaveBtn.LayoutOrder = 5; LeaveBtn.Font = Enum.Font.GothamBlack; LeaveBtn.TextColor3 = Color3.fromRGB(255, 255, 255); LeaveBtn.TextSize = 16; LeaveBtn.Text = "RETURN TO BASE"; LeaveBtn.Visible = false
	...
	local function UpdateActionGrid(battleState)
		...
		local function CreateBtn(sName, color, order)
			...
			btn.RichText = true 
			btn.Font = Enum.Font.GothamBold; btn.TextSize = 12; btn.LayoutOrder = order or 10
