...
local MainFrame, ContentArea, TabsWrapper
...
function ProfileTab.Init(parentFrame, tooltipMgr)
	...
	ShowcaseCard.Size = UDim2.new(0.31, 0, 0.9, 0); ShowcaseCard.AutomaticSize = Enum.AutomaticSize.None; ShowcaseCard.BackgroundColor3 = Color3.fromRGB(20, 20, 25); ShowcaseCard.LayoutOrder = 1
	...
	MidCol.Size = UDim2.new(0.31, 0, 0.9, 0); MidCol.BackgroundColor3 = Color3.fromRGB(20, 20, 25); MidCol.LayoutOrder = 2
	...
	-- ==========================================
	TabsWrapper = Instance.new("Frame", MainFrame)
	TabsWrapper.Name = "TabsWrapper"
	TabsWrapper.Size = UDim2.new(0.32, 0, 0.9, 0)
	...
	twLayout.Padding = UDim.new(0, 10)

	local TopNav = Instance.new("ScrollingFrame", TabsWrapper)
	TopNav.Size = UDim2.new(1, 0, 0, 40); TopNav.BackgroundColor3 = Color3.fromRGB(15, 15, 18); TopNav.ScrollBarThickness = 0; TopNav.ScrollingDirection = Enum.ScrollingDirection.X; TopNav.LayoutOrder = 1
	...
	ContentArea.Size = UDim2.new(1, 0, 1, -50); ContentArea.AutomaticSize = Enum.AutomaticSize.None; ContentArea.BackgroundTransparency = 1; ContentArea.LayoutOrder = 2
	...
	AutoSellFrame.Size = UDim2.new(1, 0, 0, 35); AutoSellFrame.Position = UDim2.new(0, 0, 0, 40); AutoSellFrame.BackgroundTransparency = 1
	...
	asLabel.Size = UDim2.new(0, 70, 1, 0); asLabel.BackgroundTransparency = 1; asLabel.Font = Enum.Font.GothamBold; asLabel.TextColor3 = Color3.fromRGB(180, 180, 180); asLabel.TextSize = 12; asLabel.TextXAlignment = Enum.TextXAlignment.Right; asLabel.Text = "Auto-Sell:"

	asLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function() 
		AutoSellFrame.CanvasSize = UDim2.new(0, asLayout.AbsoluteContentSize.X + 20, 0, 0) 
	end)
	...
	local function CreateAutoSell(rarity, color)
		...
		asBtn.Size = UDim2.new(0, 85, 1, 0); asBtn.Font = Enum.Font.GothamBold; asBtn.TextColor3 = color; asBtn.TextSize = 11; asBtn.Text = rarity
	...
	FilterFrame.Size = UDim2.new(1, 0, 0, 35); FilterFrame.Position = UDim2.new(0, 0, 0, 80); FilterFrame.BackgroundTransparency = 1
	...
	InvGrid.Size = UDim2.new(1, -10, 1, -125); InvGrid.Position = UDim2.new(0, 5, 0, 120); InvGrid.BackgroundTransparency = 1; InvGrid.BorderSizePixel = 0; InvGrid.ScrollBarThickness = 4
	local gl = Instance.new("UIGridLayout", InvGrid)
	gl.CellSize = UDim2.new(0, 85, 0, 85); gl.CellPadding = UDim2.new(0, 10, 0, 15); gl.HorizontalAlignment = Enum.HorizontalAlignment.Center; gl.SortOrder = Enum.SortOrder.LayoutOrder
