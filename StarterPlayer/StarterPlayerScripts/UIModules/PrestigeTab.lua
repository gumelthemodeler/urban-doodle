...
function PrestigeTab.Init(parentFrame)
	...
	Title.Size = UDim2.new(1, 0, 0, 40); Title.BackgroundTransparency = 1; Title.Font = Enum.Font.GothamBlack; Title.TextColor3 = Color3.fromRGB(255, 215, 100); Title.TextSize = 32; Title.Text = "PRESTIGE TALENTS"
	ApplyGradient(Title, Color3.fromRGB(255, 215, 100), Color3.fromRGB(255, 150, 50))

	PointsLabel = Instance.new("TextLabel", MainFrame)
	PointsLabel.Size = UDim2.new(1, 0, 0, 25); PointsLabel.Position = UDim2.new(0, 0, 0, 45); PointsLabel.BackgroundTransparency = 1; PointsLabel.Font = Enum.Font.GothamBlack; PointsLabel.TextColor3 = Color3.fromRGB(150, 255, 150); PointsLabel.TextSize = 18; PointsLabel.Text = "AVAILABLE POINTS: 0"

	local TreeScroll = Instance.new("ScrollingFrame", MainFrame)
	TreeScroll.Size = UDim2.new(1, 0, 1, -260); TreeScroll.Position = UDim2.new(0, 0, 0, 80); TreeScroll.BackgroundColor3 = Color3.fromRGB(12, 12, 15); TreeScroll.ScrollBarThickness = 6; TreeScroll.BorderSizePixel = 0
	Instance.new("UICorner", TreeScroll).CornerRadius = UDim.new(0, 12); Instance.new("UIStroke", TreeScroll).Color = Color3.fromRGB(40, 40, 50)
	TreeScroll.CanvasSize = UDim2.new(0, 0, 0, 900)

	-- [[ DRAW BRANCH BACKDROPS ]]
	local function CreateBranchBackdrop(name, xPos, colorHex)
		local bg = Instance.new("Frame", TreeScroll)
		bg.Size = UDim2.new(0.28, 0, 0.95, 0); bg.Position = UDim2.new(xPos, 0, 0.025, 0); bg.AnchorPoint = Vector2.new(0.5, 0)
		bg.BackgroundColor3 = Color3.fromRGB(16, 16, 20); bg.ZIndex = 0
		Instance.new("UICorner", bg).CornerRadius = UDim.new(0, 12); Instance.new("UIStroke", bg).Color = Color3.fromRGB(30, 30, 40)

		local header = Instance.new("TextLabel", bg)
		header.Size = UDim2.new(1, 0, 0, 40); header.BackgroundTransparency = 1; header.Font = Enum.Font.GothamBlack; header.TextColor3 = Color3.fromHex(colorHex:gsub("#","")); header.TextSize = 18; header.Text = name; header.ZIndex = 1

		local sep = Instance.new("Frame", bg)
		sep.Size = UDim2.new(0.8, 0, 0, 3); sep.Position = UDim2.new(0.1, 0, 0, 40); sep.BackgroundColor3 = Color3.fromHex(colorHex:gsub("#","")); sep.BorderSizePixel = 0; sep.ZIndex = 1
	...
	CreateBranchBackdrop("SCOUT BRANCH", 0.2, "#55AAFF")
	CreateBranchBackdrop("COMMANDER BRANCH", 0.5, "#FFD700")
	CreateBranchBackdrop("TITAN BRANCH", 0.8, "#AA55FF")
	...
	Instance.new("UICorner", DetailPanel).CornerRadius = UDim.new(0, 12); Instance.new("UIStroke", DetailPanel).Color = Color3.fromRGB(60, 60, 80)

	DTitle = Instance.new("TextLabel", DetailPanel); DTitle.Size = UDim2.new(1, -20, 0, 35); DTitle.Position = UDim2.new(0, 20, 0, 10); DTitle.BackgroundTransparency = 1; DTitle.Font = Enum.Font.GothamBlack; DTitle.TextColor3 = Color3.fromRGB(255, 255, 255); DTitle.TextSize = 24; DTitle.TextXAlignment = Enum.TextXAlignment.Left

	DDesc = Instance.new("TextLabel", DetailPanel); DDesc.Size = UDim2.new(0.5, 0, 0, 60); DDesc.Position = UDim2.new(0, 20, 0, 45); DDesc.BackgroundTransparency = 1; DDesc.Font = Enum.Font.GothamMedium; DDesc.TextColor3 = Color3.fromRGB(180, 180, 190); DDesc.TextSize = 14; DDesc.TextWrapped = true; DDesc.TextXAlignment = Enum.TextXAlignment.Left; DDesc.TextYAlignment = Enum.TextYAlignment.Top
	...
	DCost = Instance.new("TextLabel", DetailPanel); DCost.Size = UDim2.new(0.3, 0, 0, 30); DCost.Position = UDim2.new(0.68, 0, 1, -45); DCost.BackgroundTransparency = 1; DCost.Font = Enum.Font.GothamBlack; DCost.TextColor3 = Color3.fromRGB(255, 215, 100); DCost.TextSize = 18; DCost.TextXAlignment = Enum.TextXAlignment.Right

	DReq = Instance.new("TextLabel", DetailPanel); DReq.Size = UDim2.new(0.5, 0, 0, 20); DReq.Position = UDim2.new(0, 20, 1, -35); DReq.BackgroundTransparency = 1; DReq.Font = Enum.Font.GothamBold; DReq.TextColor3 = Color3.fromRGB(255, 100, 100); DReq.TextSize = 14; DReq.TextXAlignment = Enum.TextXAlignment.Left

	UnlockBtn = Instance.new("TextButton", DetailPanel)
	UnlockBtn.Size = UDim2.new(0.25, 0, 0, 45); UnlockBtn.Position = UDim2.new(0.98, 0, 1, -55); UnlockBtn.AnchorPoint = Vector2.new(1, 0); UnlockBtn.Font = Enum.Font.GothamBlack; UnlockBtn.TextColor3 = Color3.fromRGB(255, 255, 255); UnlockBtn.TextSize = 16; UnlockBtn.Text = "UNLOCK"
	...
	for id, node in pairs(GameData.PrestigeNodes) do
		...
		if node.Req and GameData.PrestigeNodes[node.Req] then
			...
			line.Size = UDim2.new(0, 8, mappedY - reqMappedY, 0)
			line.Position = UDim2.new(node.Pos.X.Scale, 0, reqMappedY, 0)
		...
		btn.Position = UDim2.new(node.Pos.X.Scale, 0, mappedY, 0)
		...
		iconLbl.Font = Enum.Font.GothamBlack; iconLbl.TextColor3 = Color3.fromRGB(100, 100, 100); iconLbl.TextSize = 22; iconLbl.ZIndex = 6
		...
		btn.MouseButton1Click:Connect(function()
			...
			elseif not hasReq then 
				...
				DReq.Text = "AVAILABLE TO UNLOCK"; DReq.TextColor3 = Color3.fromRGB(200, 200, 200); UnlockBtn.Text = "UNLOCK"
