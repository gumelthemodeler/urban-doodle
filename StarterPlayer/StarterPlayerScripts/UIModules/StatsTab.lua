...
local function CreateStatRow(statName, parent, isTitan, layoutOrder, amtInput)
	...
	local function makeBtn(text, scaleW)
		...
		b.Size = UDim2.new(scaleW, 0, 0.85, 0); b.Text = text; b.Font = Enum.Font.GothamBold; b.TextColor3 = Color3.fromRGB(255, 255, 255); b.TextSize = 12
...
function StatsTab.Init(parentFrame, tooltipMgr)
	...
	local function SetupPanel(titleTxt, statList, isTitan, parent)
		...
		panel.Size = UDim2.new(0.48, 0, 0, 0); panel.AutomaticSize = Enum.AutomaticSize.Y; panel.BackgroundColor3 = Color3.fromRGB(20, 20, 25)
		...
		allBtn.Size = UDim2.new(0.4, 0, 0.8, 0); allBtn.Text = "ALL"; allBtn.Font = Enum.Font.GothamBold; allBtn.TextColor3 = Color3.fromRGB(255, 255, 255); allBtn.TextSize = 11
	...
	TrainContainer.Size = UDim2.new(1, 0, 0, 180)
	TrainContainer.BackgroundTransparency = 1
	TrainContainer.LayoutOrder = 2
	...
	tcLayout.Padding = UDim.new(0.04, 0)
	...
	local function CreateTrainBox(isTitan)
		...
		Instance.new("UIStroke", box).Color = Color3.fromRGB(80, 80, 90)
		...
		title.Text = isTitan and "TITAN TRAINING" or "SOLDIER TRAINING"
		title.ZIndex = 2

		local comboLbl = Instance.new("TextLabel", box)
		comboLbl.Size = UDim2.new(1, -20, 0, 30)
		...
		local tBtn = Instance.new("TextButton", box)
		tBtn.Size = UDim2.new(0.4, 0, 0, 50)
		...
		tBtn.Text = isTitan and "TRAIN TITAN" or "TRAIN SOLDIER"
		tBtn.ZIndex = 3
		Instance.new("UITextSizeConstraint", tBtn).MaxTextSize = 14

		if isTitan then
			ApplyButtonGradient(tBtn, Color3.fromRGB(200, 60, 60), Color3.fromRGB(120, 30, 30), Color3.fromRGB(80, 20, 20))
		else
			ApplyButtonGradient(tBtn, Color3.fromRGB(80, 180, 80), Color3.fromRGB(40, 100, 40), Color3.fromRGB(20, 80, 20))
		end

		local function CreateFloatingText(textStr, color, startPos)
			local fTxt = Instance.new("TextLabel", box)
