...
function BattleTab.Init(parentFrame)
	...
	-- [[ SELECTION CAROUSEL SETUP (MOBILE RELATIVE SIZE) ]]
	...
	SelectionTitle.Size = UDim2.new(1, -150, 0, 35)
	SelectionTitle.Position = UDim2.new(0, 140, 0, 10)
	...
	SelectionCarousel.Size = UDim2.new(1, 0, 1, -55)
	SelectionCarousel.Position = UDim2.new(0, 0, 0, 55)
	SelectionCarousel.BackgroundTransparency = 1
	SelectionCarousel.ScrollingDirection = Enum.ScrollingDirection.X
	SelectionCarousel.ScrollBarThickness = 0
	...
	sListLayout.Padding = UDim.new(0, 20)
	...
	sListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
		SelectionCarousel.CanvasSize = UDim2.new(0, sListLayout.AbsoluteContentSize.X + 40, 0, 0)
	end)
	...
	local function OpenSelectionMenu(titleText, dataTable, onPlayFunc)
		...
		for _, key in ipairs(sortedKeys) do
			...
			card.Size = UDim2.new(0.6, 0, 0.85, 0) -- Mobile Relative Scale
			...
			Instance.new("UIStroke", card).Color = Color3.fromRGB(60, 60, 70)

			local bgImg = Instance.new("ImageLabel", card)
			bgImg.Size = UDim2.new(1, 0, 1, 0)
			bgImg.BackgroundTransparency = 1
			bgImg.Image = "rbxassetid://0" -- REPLACE THIS WITH YOUR BOSS DECALS
			...
			nLbl.Size = UDim2.new(1, -30, 0, 25)
			nLbl.Position = UDim2.new(0, 15, 1, -125)
			...
			rLbl.Size = UDim2.new(1, -30, 0, 20)
			rLbl.Position = UDim2.new(0, 15, 1, -95)
			...
			dLbl.Size = UDim2.new(1, -30, 0, 40)
			dLbl.Position = UDim2.new(0, 15, 1, -75)
			...
			pBtn.Size = UDim2.new(1, -30, 0, 35)
			pBtn.Position = UDim2.new(0, 15, 1, -45)
	...
	-- [[ MODES CAROUSEL SETUP (MOBILE RELATIVE SIZE) ]]
	ModesCarousel = Instance.new("ScrollingFrame", ModesContainer)
	ModesCarousel.Size = UDim2.new(1, 0, 1, -60)
	...
	CreateModeCard("NIGHTMARE HUNTS", "Face corrupted Titans to obtain legendary Cursed Weapons.", "rbxassetid://0", 1, function()
		OpenSelectionMenu("SELECT NIGHTMARE HUNT", EnemyData.NightmareHunts, function(bossId)
			Network:WaitForChild("DungeonAction"):FireServer("StartHunt", bossId)
		end)
	end)

	CreateModeCard("EXPEDITIONS", "Explore beyond the walls to scavenge vital resources.", "rbxassetid://0", 2, function()
		PlayTransition("DEPARTING ON EXPEDITION...", function()
			Network:WaitForChild("CombatAction"):FireServer("EngageEndless")
		end)
	end)

	CreateModeCard("THE PATHS", "Traverse the endless desert of Ymir to unlock stat points.", "rbxassetid://0", 3, function()
		PlayTransition("CONNECTING TO THE COORDINATE...", function()
			Network:WaitForChild("CombatAction"):FireServer("EngagePaths")
		end)
	end)

	CreateModeCard("PVP ARENA", "Test your ODM combat skills against other players.", "rbxassetid://0", 4, function()
		if _G.AOT_SwitchTab then _G.AOT_SwitchTab("PvP") else Network:WaitForChild("PvPAction"):FireServer("JoinQueue") end
	end)

	CreateModeCard("MULTIPLAYER RAID", "Deploy your party to take down Colossal threats.", "rbxassetid://0", 5, function()
	...
	CreateModeCard("WORLD BOSS", "A catastrophic threat has appeared. Intercept immediately.", "rbxassetid://0", 6, function()
	...
	-- ==========================================
	-- [[ 4. PARTY MENU UI (Mobile Centered Modal) ]]
	-- ==========================================
	PartyToggleBtn = Instance.new("TextButton", ModesContainer)
	PartyToggleBtn.Size = UDim2.new(0, 160, 0, 40)
	PartyToggleBtn.Position = UDim2.new(0.5, 0, 1, -10)
	...
	PartyContainer.Size = UDim2.new(0.85, 0, 0.7, 0) -- Mobile Relative Scale
	...
	closePartyBtn.Position = UDim2.new(1, -10, 0, 5)
	...
	createBtn.Position = UDim2.new(0.05, 0, 0, 45)
	...
	leaveBtn.Position = UDim2.new(0.05, 0, 0, 85)
	...
	invBox.Position = UDim2.new(0.05, 0, 0, 130)
	...
	invBtn.Position = UDim2.new(0.67, 0, 0, 130)
	...
	pMemScroll.Size = UDim2.new(0.9, 0, 1, -175)
	pMemScroll.Position = UDim2.new(0.05, 0, 0, 170)
	pMemScroll.BackgroundTransparency = 1
	pMemScroll.ScrollBarThickness = 0
